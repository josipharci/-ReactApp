...
const About = () => {
   return(
         <div className="about_container">
           ...
           Lucky Rabbit Club was created becouse we are tired of so much rug pulls and useless staking for earning ponzi coin! The Lucky Rabbit team created the NFT project as a way to share their beautiful artwork with collectors and fans around the world. The NFTs allow collectors to own a truly one-of-a-kind piece and support the artists in their work. We have added a new trade nexus tool to our server (Which will be available until mint, after mint tools will be available only to holders). 🍀 This tool includes analytics, mints, trackers, and LMNFT capabilities.🍀 We are confident that this new addition will enhance your trading experience and provide valuable insights.🍀
